...
router.post(
    ...
    ValidateRequest(AcademicDepartmentValidation.createAcademicDepartmentZodValidationSchema),
...
router.patch(
    '/:departmentId',
    ValidateRequest(AcademicDepartmentValidation.UpdateAcademicDepartmentZodValidationSchema),
